...
app.get('/hello', allowCors((req, res) => {
...
app.get("/userinfo", verifyToken, allowCors(async (req, res) => {
...
app.get("/getallusers", allowCors(async (req, res) => {
  try {
...
app.post("/createnewchat", allowCors(async (req, res) => {
...
app.post("/getallcontactlist", allowCors(async (req, res) => {
  ...
  try {
    ...
    app.get("/gettheprofiledetails/:contactId", allowCors(async (req, res) => {
    ...
    app.post("/sendmessage", allowCors(async (req, res) => {
      try {
    ...
    app.get("/fetchallmessages/:userId/:chatId", allowCors(async (req, res) => {
      try {
    ...
    app.delete("/deletechat", allowCors(async (req, res) => {
    ...
    app.post('/createnewgroupchat', allowCors(async (req, res) => {
    ...
    app.post('/getallchatrooms', allowCors(async (req, res) => {
    ...
    app.post('/joinnewchatroom', allowCors(async (req, res) => {
    ...
    io.on("connection", (socket) => {
      ...
      socket.on("new message", (newMessageReceived) => {
        const { chatroom } = newMessageReceived;
        if (!chatroom.participants) return console.log("chat.user not define");
